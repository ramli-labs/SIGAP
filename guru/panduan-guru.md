...
- Refleksi teks bebas tidak dinilai otomatis, jadi sisihkan waktu untuk membacanya (muncul di dashboard).
...
- **Gambar kasus adalah asset sintetis berlabel** yang dibuat khusus untuk latihan (ilustrasi buatan).
