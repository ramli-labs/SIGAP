...
- [ ] 71b. **Video CASE 004 masih bisa di-scrub saat dilayani service worker** (muat ulang sampai SW aktif, buka FRAME ANALYZER, geser slider ke 00:05.6 → artefak wajah terlihat; BACKGROUND CONTINUITY memuat keempat cuplikan). Service worker harus menjawab permintaan `Range` dengan **206**, bukan 200 penuh; kalau salah, `video.seekable` kosong dan slider diam di frame 0.
